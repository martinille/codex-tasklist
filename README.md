...
- Session-end cleanup is implemented and unit-tested; actual Codex exit/resume cleanup still needs an end-to-end check. Unexpected termination with the parent shell left open is not covered.
